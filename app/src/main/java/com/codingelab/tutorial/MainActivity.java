    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.onSyn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    // Clear all data in the database on the server
                    TruncateServerTable();
                    // Enter all the data in the local database
                    SyncData();
        ...
        btnser.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(MainActivity.this, phpsearch.class);
                startActivity(i);
            }
        });
        ////////////////////////////////////////////////////////////////////////////////////////////
...
// Open the local database
    ...
    private void TruncateServerTable() {
        ...
        class GetJSON extends AsyncTask<Void, Void, String> {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    URL url = new URL("http://192.168.43.58:8080/sqli/mysql_truncate.php");
